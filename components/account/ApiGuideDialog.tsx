...
export function ApiGuideDialog({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative z-10 my-auto w-full max-w-2xl rounded-2xl border border-line bg-surface shadow-[0_24px_80px_-24px_rgba(0,0,0,0.8)]">
        <header className="sticky top-0 z-[1] flex items-start justify-between gap-4 rounded-t-2xl border-b border-line bg-surface px-5 py-4">
