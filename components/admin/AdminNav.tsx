...
import { BotIcon, GearIcon, LinkIcon, ShieldUsersIcon, UserIcon } from "@/components/admin/admin-icons";
import { Logo } from "@/components/brand/Logo";
import { ProfileMenu, type SidebarUser } from "@/components/dashboard/ProfileMenu";
import { cn } from "@/lib/cn";

export type AdminTab = "dashboard" | "management" | "community" | "bots" | "account";
...
const NAV = [
  ...
  { key: "community", label: "Community Access Links", Icon: LinkIcon, href: "/admin/community" },
