  ...
  return (
    <AdminCard title="Add New Bot" subtitle="Pick a category, upload the bot config and signal CSV, backtest, then save.">
      <div className="flex flex-col gap-6">
        ...
        {step === 3 && result && (
          <ResultsView name={name} timeframe={timeframe} riskClass={riskClass} result={result} />
        )}
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-xs text-muted">
        Backtested {result.candleCount.toLocaleString()} candles over the last {result.windowDays} days. Headline row is the{" "}
